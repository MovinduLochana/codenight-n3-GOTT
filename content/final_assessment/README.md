...
| **17** | 🟡 Intermediate | **Custom Errors** | Creating error types, custom `Error()` format, `errors.As` | `[17_Intermediate_Custom_Errors](./17_Intermediate_Custom_Errors)` |
| **18** | 🟡 Intermediate | **Worker Pool** | Concurrency, goroutines, channels, `sync.WaitGroup` | `[18_Intermediate_Worker_Pool](./18_Intermediate_Worker_Pool)` |
