      ...
      <CardContent className="mt-6">
        ...
        <form action={initiateOAuthFlow}>
          <Button
            type="submit"
            size="lg"
            className="flex h-12 w-full items-center justify-center gap-3 border border-white/10 bg-white font-mono text-xs font-semibold tracking-wide uppercase text-black transition-colors hover:border-white/10 hover:bg-white hover:opacity-95"
          >
            <Image
